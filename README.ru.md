...
Нативное macOS-приложение для системной голосовой диктовки. Жмёшь горячую клавишу, говоришь, ещё раз — расшифрованный текст вставляется в активное приложение. Полностью локально, оффлайн, приватно.
